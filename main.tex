...
\hypersetup{
	pdfborder={1 1 0},
	pdfcreator=LaTeX,
    pdftitle={Notas de Cálculo III},
	pdfauthor={Antonio M. Mendoza},
    pdfsubject={Estas notas se elaboraron con el propósito de servir como recurso para comprender el Cálculo de varias variables.},
...
{%
	\begin{tikzpicture}%
		\node [font=\fontsize{1cm}{1.2cm}\selectfont\bfseries] (chapterLabel) {\hspace{-.3ex}\chaptertitlename};
...
%		Drawing the rubber
		...
		\draw[white] (rubberSouthWest)[xshift=\subtitleRubberWidth/2] node [
			...
			%\chapterNumberFont
            \fontsize{3cm}{3.6cm}\bfseries\itshape\selectfont
			\color{White}
...
\begin{tikzpicture}[remember picture,overlay]%
    \node at (current page.north west){\begin{tikzpicture}[remember picture,overlay]%   
        ...
        %\node[anchor=south east] at (\paperwidth-1cm,-\paperheight+1cm){\parbox[t][][t]{12cm}{\printcontents{l}{0}{\setcounter{tocdepth}{0}}}};
        \node[right] at ($(current page.west)+(2,0.75)$) {\parbox[t][][t]{15cm}{\strut\raggedright\color{white}\fontsize{60}{60}\bfseries#2}};
    \end{tikzpicture}};
\end{tikzpicture}}%
\@endpart}
\def\@spart#1{%
